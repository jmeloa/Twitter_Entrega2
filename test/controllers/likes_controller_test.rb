...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { Tweet_Post_id: @like.Tweet_Post_id, User_id: @like.User_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { Tweet_Post_id: @like.Tweet_Post_id, User_id: @like.User_id } }
